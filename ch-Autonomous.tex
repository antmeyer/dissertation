...
% a \ac{ULM} system consists of independent words without contextdoes not have access to context, it simply 
...
\midrule %heading
$\langle \textsc{kick}, \{ \textsc{p:1}, \textsc{n:}\text{sg} \}\rangle $ & \multirow{5}{*}{$\Bigg\langle \textsc{kick}, 
\Big\{ \big((\textsc{p:}\text{1}\vee\text{2}) \land (\textsc{n:}\text{sg} \vee \text{pl})\big) 
\vee (\textsc{p:}\text{3}\land \textsc{n:}\text{pl}) \Big\} \Bigg\rangle$} 
& \multirow{5}{*}{kick} \\ \cmidrule{1-1}
$\langle \textsc{kick},\{\textsc{p:2}$, \textsc{n}:{sg}\} $\rangle$  &\\ \cmidrule{1-1}
$\langle \textsc{kick}, \{\textsc{p:1}$, \textsc{n}:{pl}\} $\rangle$  & \\ \cmidrule{1-1}
$\langle \textsc{kick}, \{\textsc{p:2}$, \textsc{n}:{pl}\} $\rangle$ &  \\ \cmidrule{1-1}
$\langle \textsc{kick}, \{\textsc{p:3}$, \textsc{n}:{pl}\} $\rangle$ & \\ \midrule
...
%  \end{exe} 
 ...
 is complex, its morphomic representation $\mu{\textsc{word}}$ 
  ...
  which, according to \citet{round:2015}, can viewed as operations, 
...
%Most \ac{ULM} systems would probably tend to decompose \textit{-it} 

...
\caption{The English past participle is a metamorphome: It is a single, abstract morphome that spans multiple lexemes and comprises multiple stem types and affixes.}
\label{tab:engpastpart}
\end{mdframed}
\end{table}

...
Essentially, each category in this taxonomy represents a different approach to relating forms---a different set of standards or conditions for putting forms in the same category. %--orms can be considered ``the same.''

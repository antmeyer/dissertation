...
section~\ref{sec:mcmm-learning} %chapter~\ref{ch:MCMM} 
...
global reconstruction can no longer be decreased significantly at the 
current cluster count. In principle, this incremental addition of clusters is 
to continue until the global error is sufficiently close to $0$, i.e., falls 

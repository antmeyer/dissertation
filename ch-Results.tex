...
\subsection{Intrinsic Results}
	The intrinsic results are displayed in tables~\ref{tab:results-500} and \ref{tab:results-1000}. These are the ``master" tables, so to speak, for the intrinsic results, wherein each row %in these tables 
...
\item The TR BP scores are conspicuously low compared to TS and O. [cite some numbers.]  %Exactly two measures, namely BCubed Precision and BCubed Recall go into the F-score computation. Of these, BP seems to be the m
...
that relates related stressed vowels to other stressed vowels as members of a stressed-vowel class. In effect, therefore, the inclusion of stress marking in the TS dataset amounted the doubling the size of the vowel inventory from 5 to 10 symbols, and hence expanding the alphabet from 29 to 34 symbols. This resulted in a considerable increase in the number of features, as the number features depended directly on the size of the alphabet (see REF). 
	...
	I had thought that this would amount to too much information that was not particularly useful, but it seems to have been useful in some way. 
...
%DR & $s$ & Purity &  BP & BR & F & Cov & $K^{\prime}$ \\ \hline\hline
...
\setlength{\extrarowheight}{6pt}
\begin{tabular}{cc|ccccrr}
DR & $s$ & Purity &  BP & BR & F & Coverage & $K^{\prime}$ \\ \hline\hline
...
\setlength{\extrarowheight}{6pt}
\begin{tabular}{cc|ccccrr}
DR & $\delta$ & Purity &  BP & BR & F & Coverage & $K^{\prime}$ \\ \hline\hline
...
\setlength{\extrarowheight}{6pt}
\begin{tabular}{cc|ccccrr}
$s$ & $\delta$ & Purity &  BP & BR & F & Coverage & $K^{\prime}$ \\ \hline\hline
...
6 & 3 & 0.474 & 0.277 & 0.525 & 0.363 & 11858 & 79 \\ \hline
\multicolumn{2}{c|}{\textit{Means:}} & 0.502 & 0.286 & 0.530 & 0.365 & 11966 & 181 \\
\end{tabular}
}
...
3 & 3 & 0.414 & 0.243 & 0.665 & 0.356 & 3444 & 147 \\ \hline
\multicolumn{2}{c|}{\textit{Means:}}  & 0.445 & 0.295 & 0.553 & 0.373 & 5605 & 215 \\
\end{tabular}
}
...
3 & 3 & 0.393 & 0.234 & 0.667 & 0.346 & 3443 & 159 \\ \hline

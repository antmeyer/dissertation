...
\begin{table}[!ht]
\centering
 \subtable[ Transcriptions with Stress Markings (TS) $K = 1000$\label{subtab:intr-TS-1000}]{ %(TS), $K=1000$ 
\centering
\fontsize{11pt}{12pt}\selectfont
...
\end{tabular}
 ...
 \subtable[ Orthographic (O), $K=1000$]{
\centering
\small
\setlength{\extrarowheight}{3pt}
\begin{tabular}{cc|ccccrr}
...
\end{tabular}
 ...
 \subtable[ Transcriptions, No Stress (TR), $K = 1000$\label{subtab:extr-1000-tr}]{
\setlength{\extrarowheight}{2pt}
\fontsize{11pt}{12pt}\selectfont
%\footnotesize
%\small

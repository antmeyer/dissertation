...
\begin{table}[!ht]
\centering
\subtable[{\normalsize Transcriptions with Stress Marking (TS), $K = 500$}\label{subtab:intr-TS-500}]{
%\captionsetup{font=Large,labelfont={bf,sf}} 
%\small
\centering
...
%\begin{table}
\subtable[{\normalsize Transcriptions, No Stress Marking (TR), $K = 500$}\label{subtab:intr-TR-500}]{
%\footnotesize
%\small
\centering
\fontsize{11pt}{12pt}\selectfont
...
%\begin{table}
%\ContinuedFloat
\subtable[{\normalsize Orthographic (O), $K=500$}]{
\centering
\fontsize{11pt}{12pt}\selectfont
%\footnotesize
%\small
...
\begin{table}[!ht]
\centering
\subtable[\normalsize Transcriptions with Stress Markings (TS) $K = 1000$\label{subtab:intr-TS-1000}]{ %(TS), $K=1000$ 
\centering
\fontsize{11pt}{12pt}\selectfont
...
%\begin{table}
\subtable[\normalsize Transcriptions, No Stress Marking (TR), $K = 1000$\label{subtab:intr-TR-1000}]{
%\small
\centering
\fontsize{11pt}{12pt}\selectfont
\setlength{\extrarowheight}{3pt}
...
\subtable[\normalsize Orthographic (O), $K=1000$]{
\centering
\small
\setlength{\extrarowheight}{3pt}
\begin{tabular}{cc|ccccrr}
...
%\setlength{\extrarowheight}{3pt}
%\caption{ Transcriptions with Stress Marking (TS)}
\subtable[\normalsize Transcriptions with Stress (TS), $K = 1000$\label{subtab:extr-1000-ts}]{
...
\subtable[\normalsize Transcriptions, No Stress (TR), $K = 1000$\label{subtab:extr-1000-tr}]{
\setlength{\extrarowheight}{2pt}
\fontsize{11pt}{12pt}\selectfont
%\footnotesize
%\small
...
\subtable[\fontsize{11pt}{12pt}\selectfont Orthographic (O), $K = 1000$\label{subtab:extr-1000-o}]{
%\footnotesize
%\small
\fontsize{11pt}{12pt}\selectfont
\setlength{\extrarowheight}{2pt}

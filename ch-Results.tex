...
referencing \textit{i}: \texttt{d<\a'{i}} is especially strong with an activity of 1.0, and \texttt{\a'{i}<q} 
...
Our last cluster example in this section is the one in figure~\ref{fig:cluster-339-4-3-TS}. It demonstrates 
Multimorph's capacity to learn vowel patterns. The patten in this case is \textit{a.\'{e}}.
 It it is a morphological component of \textit{Hitpa`el} binyan, 
...
It seems noteworthy 
that this increase apparently did not result in an
information overload---that is, that it did not, it would seem, 
produce more noise than useful information, as the models trained on stress-marked transcriptions
performed better than those trained on stressless transcriptions. 

On the other hand, the presence of the all vowels in transcriptional was not always helpful. The 

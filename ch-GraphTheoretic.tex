...
nodes $\mu_1$, $\mu_2$, and $\mu_3$. That is, we can 
simply move up $\mu_2$ so that it is situated between 
$\mu_1$ and $\mu_3$, and all three morphs are 
...
%\vspace{-20pt}
	\centering
	\subfigure[\fontsize{11pt}{12pt}\selectfont Multilinear approach\label{subfig:multilinear-gt}]{
	...
	\subfigure[\fontsize{11pt}{12pt}\selectfont Linear approach\label{subfig:linear-gt}]{
	\begin{tikzpicture}[shorten >=1pt,draw=black!100]
...
% When this connection takes place, the individual Cs and Vs inherit the individual feature matrices composing the morphs and in effect take on the phonological identities
%embodied by these feature matrices.  
%on the identities of the phonological elements that compose the morphs. 
Just as \textipa{/hi/} and \textipa{/i/} (i.e, the feature bundles they represent) compose 

...
%and each of $\mathbf{M}$'s $K$ columns corresponds to a particular 
...
which will be concerned with the actual testing of the first part’s hypothesis.
 ...
 will address these in the following chapters. The next chapter discusses the setup 
 of the experiments whereby Multimorph was evaluated.

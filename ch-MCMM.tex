...
\label{subsec:example}
 ...
 \begin{center}
 \subfigure[\fontsize{11pt}{12pt}\selectfont Observed Data\label{fig:example:subfig0-1}]{
 \begin{tikzpicture}[shorten <=1pt,->,draw=black!100]
 	\scriptsize
 ...
 %\begin{minipage}{.3\textwidth}
 \begin{center}
 \subfigure[\fontsize{11pt}{12pt}\selectfont Learning in Progress\label{fig:example:subfig1-1}]{
 \begin{tikzpicture}[shorten <=1pt,->,draw=black!100]
 	\footnotesize
 	\def \attic{5.95cm}
 	\def \rowtwoht{5.4cm}
...
% 	\def \china{0cm}
 ...
 \subfigure[\fontsize{11pt}{12pt}\selectfont Convergence\label{fig:example:subfig2-1}]{

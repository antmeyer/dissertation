...
RBM activation functions. However, some authors, e.g., \citet{rudy-and-taylor:2014}, have included biases in the activation functions of classical autoencoders. %but the classical encoder could in principle accomodate biases \citep{song:2013}   But the 

...
%\thispagestyle{empty}
%%\nobibliography*
%\moveleft.5\hoffset\centerline{\textbf{\Large Anthony J. Meyer}}
...
\centerline{\LARGE Anthony James Meyer}
%\begin{center}
%\textbf{\Large Anthony J. Meyer} \\
...
%\centerline{\textbf{\large Highly Versatile Computational Linguist}}
...
%\onehalfspacing
%%\hangindent=1em \textbf{\large Trained linguist} with special expertise in morphology, Hebrew and Semitic linguistics, and in particular the non-concatenative morphology of Semitic languages. Thoroughly trained in each of the core subfields of linguistics, i.e., phonetics, phonology, morphology, syntax, and semantics. Regarded by colleagues as an authority in matters of general linguistics and linguistic theory.  
%\hangindent=1em \textbf{\large Trained linguist} with special expertise in morphology, Hebrew and Semitic linguistics, and in particular the non-concatenative morphology of Semitic languages. Thoroughly trained in each of the core subfields of linguistics, i.e., phonetics, phonology, morphology, syntax, and semantics. Regarded by colleagues as an authority in matters of general linguistics and linguistic theory.
%\vspace{16pt}
%
%%\hangindent=1em \textbf{\large Proficient programmer} with expertise in computational morphology, machine learning,  
...
%
%\vspace{16pt}
%\textbf{\large Professional Competencies}
%\begin{itemize} \itemsep0em
%\item Able to program in a variety of languages, including Python, Cython, C, C++, Java, CUDA, OpenCL, PyCUDA, PyOpenCL, and OpenMP.
%\item Parallel Computing via Graphical Processing Units.
...
%\vspace{11pt}
\begin{description}
\item \textbf{PhD, Computational Linguistics}\hfill June 2019
%\vspace{-12pt}
\begin{description}
...
%\centerline{\Large Research Interests}
%\textbf{Research}
%\vspace{8pt}
...
%\centerline{\Large Research Experience}
\vspace{12pt}
...
\item Wrote the 2017 annual \texttt{https://blog.linguistlist.org/uncategorized/incredible\-parrot\-speech\-decoded\-as\-300\-years\-old\-english\-dialect/}{April Fools' news spoof}  for the LINGUIST List blog. % \url{https://blog.linguistlist.org/uncategorized/incredible-parrot-speech-decoded-as-300-years-old-english-dialect/} 
\end{itemize}
%\end{singlespace
%\end{singlespace}
%\vspace{20pt}
...
%\centerline{\Large Teaching Experience}
\vspace{6pt}
...
%\centerline{\Large Other Experience}
%\vspace{8pt}
...
%\centerline{\large Conference Proceedings}
%\vspace{-4pt}
%\begin{myindentpar}{1em}
\begin{description}
...
\end{description}
\vspace{-3pt}
\centerline{\large \textbf{Poster}} %\end{center}
%\centerline{\large Poster} %\end{center}
\begin{description}
